...
VALUES
  ...
  ('요즘IT', 'https://yozm.wishket.com/magazine/feed/', 'UX 디자인', '{}', 'seed', TRUE),
  ('DISQUIET', 'https://disquiet.io/rss', '프로덕트 디자인', '{}', 'seed', TRUE),
  ('토스 테크', 'https://toss.tech/rss.xml', '프로덕트 디자인', '{}', 'seed', TRUE),
  ('당근 테크', 'https://medium.com/feed/daangn', 'UX 디자인', '{}', 'seed', TRUE),
  ('우아한형제들', 'https://techblog.woowahan.com/feed', '프로덕트 디자인', '{}', 'seed', TRUE),
  ('카카오 테크', 'https://tech.kakao.com/feed', 'UI 디자인', '{}', 'seed', TRUE),
  ('네이버 D2', 'https://d2.naver.com/d2.atom', '디자인 시스템', '{}', 'seed', TRUE),
  ('뱅크샐러드', 'https://medium.com/feed/banksalad', 'UX 디자인', '{}', 'seed', TRUE),
  ('딜라이트룸', 'https://medium.com/feed/delightroom', 'UI 디자인', '{}', 'seed', TRUE),
  ...
  ('여기어때 테크', 'https://techblog.gccompany.co.kr/feed', 'UX 디자인', '{}', 'seed', TRUE),
  ('velog 태그', 'https://v2.velog.io/rss/tag/{keyword}', 'UX 디자인', '{"UXUI","디자인","figma"}', 'seed', TRUE)
