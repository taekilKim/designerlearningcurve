...
-- Insert Articles
INSERT INTO articles (id, title, description, url, author, thumbnail_url, created_at) VALUES
-- UX/UI 기초
...
('11111111-1111-1111-1111-111111111111', 'a1111111-1111-1111-1111-111111111112', 1,
 'UX와 UI의 차이를 명확히 이해하는 것이 첫 단계입니다. 실제 사례를 통해 개념을 익혀보세요.', NOW()),
('11111111-1111-1111-1111-111111111111', 'a1111111-1111-1111-1111-111111111114', 2,
 'Adobe에서 제시하는 15가지 원칙은 UX 디자인의 기본기를 다지는 데 필수적입니다.', NOW()),
('11111111-1111-1111-1111-111111111111', 'a1111111-1111-1111-1111-111111111111', 3,
 '2025년 최신 트렌드를 파악하면 현업에서 요구되는 디자인 방향을 이해할 수 있습니다.', NOW()),
('11111111-1111-1111-1111-111111111111', 'a1111111-1111-1111-1111-111111111113', 4,
 'AI 도구를 활용하면 디자인 작업의 효율성을 크게 높일 수 있습니다. 실무에 바로 적용해보세요.', NOW());

-- Insert Curriculum Items for Curriculum 2: UX 디자인 프로세스
INSERT INTO curriculum_items (curriculum_id, article_id, sequence, curator_note, created_at) VALUES
('22222222-2222-2222-2222-222222222222', 'a2222222-2222-2222-2222-222222222221', 1,
 'UX 디자인 프로세스의 전체 흐름을 먼저 파악하면 각 단계의 목적을 이해하기 쉽습니다.', NOW()),
('22222222-2222-2222-2222-222222222222', 'a2222222-2222-2222-2222-222222222222', 2,
 '다양한 디자인 방법론을 알아두면 프로젝트 특성에 맞는 프로세스를 선택할 수 있습니다.', NOW()),
('22222222-2222-2222-2222-222222222222', 'a2222222-2222-2222-2222-222222222224', 3,
 'UX 리서치는 사용자 중심 디자인의 핵심입니다. 체계적인 리서치 방법을 익혀보세요.', NOW()),
('22222222-2222-2222-2222-222222222222', 'a2222222-2222-2222-2222-222222222223', 4,
 '15년 경력자의 실무 경험담에서 프로세스 적용의 실제 노하우를 배울 수 있습니다.', NOW());

-- Insert Curriculum Items for Curriculum 3: 디자인 시스템
INSERT INTO curriculum_items (curriculum_id, article_id, sequence, curator_note, created_at) VALUES
('33333333-3333-3333-3333-333333333333', 'a3333333-3333-3333-3333-333333333332', 1,
 '디자인 시스템의 필요성과 기본 개념을 먼저 이해하고 시작하세요.', NOW()),
('33333333-3333-3333-3333-333333333333', 'a3333333-3333-3333-3333-333333333331', 2,
 '디자인 시스템 가이드 작성 방법을 익히면 일관성 있는 디자인을 유지할 수 있습니다.', NOW()),
('33333333-3333-3333-3333-333333333333', 'a3333333-3333-3333-3333-333333333334', 3,
 '실무에서 자주 사용하는 UI 컴포넌트를 학습하면 디자인 시스템 구축이 쉬워집니다.', NOW()),
('33333333-3333-3333-3333-333333333333', 'a3333333-3333-3333-3333-333333333333', 4,
 '실제 기업의 디자인 시스템 구축 사례를 통해 실무 적용 방법을 배워보세요.', NOW());
...
INSERT INTO curriculum_items (curriculum_id, article_id, sequence, curator_note, created_at) VALUES
('44444444-4444-4444-4444-444444444444', 'a4444444-4444-4444-4444-444444444442', 1,
 'UX/UI 디자인 트렌드를 파악하면서 디자이너의 사고방식이 어떻게 변화하고 있는지 이해하세요.', NOW()),
('44444444-4444-4444-4444-444444444444', 'a4444444-4444-4444-4444-444444444441', 2,
 'AI 시대에 디자이너가 갖춰야 할 4가지 핵심 역량을 학습하고 경쟁력을 키우세요.', NOW()),
('44444444-4444-4444-4444-444444444444', 'a4444444-4444-4444-4444-444444444443', 3,
 '디자인 씽킹을 통한 실제 문제 해결 사례로 분석적 사고를 넘어선 통찰력을 배웁니다.', NOW()),
('44444444-4444-4444-4444-444444444444', 'a4444444-4444-4444-4444-444444444444', 4,
 '2025년 UX 디자인의 주요 변화를 파악하고 미래를 준비하세요.', NOW());

-- Curriculum 5: 레퍼런스 수집과 활용
INSERT INTO curriculum_items (curriculum_id, article_id, sequence, curator_note, created_at) VALUES
('55555555-5555-5555-5555-555555555555', 'a5555555-5555-5555-5555-555555555551', 1,
 '핀터레스트, 비핸스, 드리블의 장단점을 파악하고 상황에 맞게 활용하세요.', NOW()),
('55555555-5555-5555-5555-555555555555', 'a5555555-5555-5555-5555-555555555552', 2,
 '현직 디자이너가 추천하는 다양한 레퍼런스 사이트를 탐색해보세요.', NOW()),
('55555555-5555-5555-5555-555555555555', 'a5555555-5555-5555-5555-555555555553', 3,
 '수집한 레퍼런스를 체계적으로 관리하는 방법과 도구를 익히세요.', NOW()),
('55555555-5555-5555-5555-555555555555', 'a5555555-5555-5555-5555-555555555554', 4,
 'UXUI 실무에 특화된 레퍼런스 사이트 활용 팁을 배워보세요.', NOW());

-- Curriculum 6: 사용자 리서치 실무
INSERT INTO curriculum_items (curriculum_id, article_id, sequence, curator_note, created_at) VALUES
('66666666-6666-6666-6666-666666666666', 'a6666666-6666-6666-6666-666666666664', 1,
 '관찰, 인터뷰, 설문 등 UX 리서치의 모든 기법을 먼저 전체적으로 파악하세요.', NOW()),
('66666666-6666-6666-6666-666666666666', 'a6666666-6666-6666-6666-666666666663', 2,
 '사용자 인터뷰 준비 단계부터 차근차근 배워나가세요.', NOW()),
('66666666-6666-6666-6666-666666666666', 'a6666666-6666-6666-6666-666666666662', 3,
 '실제 인터뷰 진행 방법과 사용자의 생각을 캐내는 팁을 익히세요.', NOW()),
('66666666-6666-6666-6666-666666666666', 'a6666666-6666-6666-6666-666666666661', 4,
 '토스의 실제 사례를 통해 사용자 경험 리서치를 어떻게 실무에 적용하는지 배웁니다.', NOW());

-- Curriculum 7: 문제 정의와 가설 설정
INSERT INTO curriculum_items (curriculum_id, article_id, sequence, curator_note, created_at) VALUES
('77777777-7777-7777-7777-777777777777', 'a7777777-7777-7777-7777-777777777771', 1,
 '복잡한 문제를 해결하기 위한 디자인 씽킹 프로세스의 기초를 다집니다.', NOW()),
('77777777-7777-7777-7777-777777777777', 'a7777777-7777-7777-7777-777777777772', 2,
 'HMW 질문으로 문제를 기회로 전환하는 핵심 기법을 익히세요.', NOW()),
('77777777-7777-7777-7777-777777777777', 'a7777777-7777-7777-7777-777777777773', 3,
 '협업을 통해 더 나은 아이디어를 만들어내는 방법을 배웁니다.', NOW()),
('77777777-7777-7777-7777-777777777777', 'a7777777-7777-7777-7777-777777777774', 4,
