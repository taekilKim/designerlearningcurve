...
('a1111111-1111-1111-1111-111111111115',
 '디자인 시스템 구축하기 2부 : 컬러',
 '디자인 시스템에서 컬러를 체계적으로 정의하고 관리하는 방법을 배웁니다. 확장 가능한 컬러 시스템 구축 가이드.',
 'https://brunch.co.kr/@thinkaboutlove/289',
 'Brunch', NULL, NOW()),

('a1111111-1111-1111-1111-111111111116',
 '모바일 UI 디자인 기본 요소 - 색채 Color',
 '모바일 UI에서 컬러를 효과적으로 사용하는 방법과 색채 이론의 기초를 학습합니다.',
...
('a2222222-2222-2222-2222-222222222225',
 ...
 'SK C&C 디자인킷: 사용자가 제품/서비스를 실제 맥락에서 경험하는 방식을 시각화하는 방법을 학습합니다.',
...
('a2222222-2222-2222-2222-222222222226',
 ...
 '사용자를 깊이 이해하기 위한 페르소나, 여정 맵, 세분화 기법을 종합적으로 배웁니다.',
 'https://brunch.co.kr/@kja0717/17',
 'Brunch', NULL, NOW()),
...
('a3333333-3333-3333-3333-333333333335',
 ...
 '피그마로 프로토타입을 만들어 UX를 테스트하고 팀과 아이디어를 공유하는 방법을 배웁니다.',
 'https://designbase.co.kr/figma-02-8/',
 '디자인베이스', NULL, NOW()),

('a3333333-3333-3333-3333-333333333336',
 '피그마를 활용한 프로토타입 제작방법',
 '피그마의 프로토타입 기능 업데이트로 디자인부터 프로토타이핑까지 한 곳에서 처리하는 방법을 학습합니다.',
 'https://www.elancer.co.kr/blog/detail/210',
 '이랜서 블로그', NULL, NOW())
...
-- Curriculum 2-3: Create new if needed
INSERT INTO curriculums (id, title, description, difficulty, thumbnail_url, created_at)
VALUES
('22222222-2222-2222-2222-222222222222',
 'UX 디자인 프로세스 마스터',
 '사용자 리서치부터 프로토타이핑까지, 실무에서 사용하는 UX 디자인 프로세스를 단계별로 학습합니다.',
 'intermediate', NULL, NOW()),
...
('11111111-1111-1111-1111-111111111111', 'a1111111-1111-1111-1111-111111111115', 3,
 '디자인 시스템의 컬러 관리 방법을 배우면 일관성 있는 UI를 만들 수 있습니다.', NOW()),
('11111111-1111-1111-1111-111111111111', 'a1111111-1111-1111-1111-111111111116', 4,
 '모바일 UI에서 색채를 효과적으로 활용하는 방법을 익혀보세요.', NOW()),
('11111111-1111-1111-1111-111111111111', 'a1111111-1111-1111-1111-111111111111', 5,
 '2025년 최신 트렌드를 파악하면 현업에서 요구되는 디자인 방향을 이해할 수 있습니다.', NOW()),
('11111111-1111-1111-1111-111111111111', 'a1111111-1111-1111-1111-111111111113', 6,
...
('22222222-2222-2222-2222-222222222222', 'a2222222-2222-2222-2222-222222222226', 3,
 '페르소나와 여정 맵으로 사용자를 깊이 이해하는 방법을 배웁니다.', NOW()),
('22222222-2222-2222-2222-222222222222', 'a2222222-2222-2222-2222-222222222225', 4,
 '사용자 여정지도를 실제로 작성하는 방법을 익혀보세요.', NOW()),
('22222222-2222-2222-2222-222222222222', 'a2222222-2222-2222-2222-222222222224', 5,
 'UX 리서치는 사용자 중심 디자인의 핵심입니다. 체계적인 리서치 방법을 익혀보세요.', NOW()),
('22222222-2222-2222-2222-222222222222', 'a2222222-2222-2222-2222-222222222223', 6,
...
('33333333-3333-3333-3333-333333333333', 'a3333333-3333-3333-3333-333333333335', 4,
 '피그마로 프로토타이핑하는 기본 방법을 익혀보세요.', NOW()),
('33333333-3333-3333-3333-333333333333', 'a3333333-3333-3333-3333-333333333336', 5,
 '피그마의 프로토타입 제작 기능을 실무에 활용하는 방법을 배웁니다.', NOW()),
('33333333-3333-3333-3333-333333333333', 'a3333333-3333-3333-3333-333333333333', 6,
...
INSERT INTO curriculums (id, title, description, difficulty, thumbnail_url, created_at) VALUES
('44444444-4444-4444-4444-444444444444',
 '디자인 철학과 마인드셋',
...
('44444444-4444-4444-4444-444444444444', 'a4444444-4444-4444-4444-444444444444', 2,
...
('44444444-4444-4444-4444-444444444444', 'a4444444-4444-4444-4444-444444444441', 4,
...
('55555555-5555-5555-5555-555555555555', 'a5555555-5555-5555-5555-555555555554', 3,
 'UXUI 실무에 특화된 레퍼런스 사이트 활용 팁을 배워보세요.', NOW()),
('55555555-5555-5555-5555-555555555555', 'a5555555-5555-5555-5555-555555555553', 4,
